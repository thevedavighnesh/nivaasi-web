...
import OwnerDashboard from './src/app/owner/dashboard/page';
import TenantDashboard from './src/app/tenant/dashboard/page';
import SignInPage from './src/app/account/signin/page';
import SignUpPage from './src/app/account/signup/page';
      ...
      <div style={{ textAlign: 'center', maxWidth: '600px' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <a
            ...
            onMouseEnter={(e) => (e.target as HTMLAnchorElement).style.backgroundColor = '#4a5568'}
            onMouseLeave={(e) => (e.target as HTMLAnchorElement).style.backgroundColor = '#2d3748'}
          >
            Sign Up
          </a>
        </div>
